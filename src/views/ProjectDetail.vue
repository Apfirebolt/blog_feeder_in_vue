    ...
    <main v-else class="min-w-0 border-t border-gray-200">
      <div class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
        ...
        <div class="grid sm:grid-cols-3 gap-4">
          <div v-for="image in project.pictures" :key="image.id" class="relative">
        ...
        <div class="my-3">
          ...
          <div v-for="comment in project.comments" :key="comment.id" class="mb-2">
          ...
          <div class="flex min-h-full items-center justify-center p-4 text-center">
            <TransitionChild as="template" enter="duration-300 ease-out" enter-from="opacity-0 scale-95"
              ...
              <DialogPanel
                ...
                <ProjectImageForm @close="closeAddImageForm" :addProjectImageUtil="addProjectImageUtil" />
              </DialogPanel>
            </TransitionChild>
          </div>
        </div>
        ...
        <div class="fixed inset-0 overflow-y-auto">
          <div class="flex min-h-full items-center justify-center p-4 text-center">
            <TransitionChild as="template" enter="duration-300 ease-out" enter-from="opacity-0 scale-95"
              ...
              <DialogPanel
                class="w-full max-w-lg transform overflow-hidden bg-white p-6 text-left align-middle shadow-xl transition-all">
                <ConfirmModal :message="deleteMessage" @close="closeConfirmDeleteModal"
                  :confirm-action="deleteImageUtil" :cancel-action="closeConfirmDeleteModal" />
              </DialogPanel>
            </TransitionChild>
          </div>
        </div>

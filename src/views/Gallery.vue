    ...
    <main v-else class="min-w-0 border-t border-gray-200">
      ...
      >
        <div class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
          ...
          <div>
            <div>
              <button @click="openGalleryEditForm(post)" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
            ...
            >
              ...
              >
                <GalleryForm
                  ...
                  :addGalleryUtil="addGalleryUtil"
                  :updateGalleryUtil="updateGalleryUtil"
                />
              </DialogPanel>
            </TransitionChild>
          </div>

            ...
            <div class="hidden lg:block lg:ml-10">
              <div class="flex space-x-4">
                <router-link
                  ...
                  :class="[item.current ? 'bg-gray-100' : 'hover:text-gray-700', 'px-3 py-2 rounded-md text-sm font-medium text-gray-900']"
      ...
      <DisclosurePanel class="bg-gray-50 border-b border-gray-200 lg:hidden">
        <div class="px-2 pt-2 pb-3 space-y-1">
          <DisclosureButton
            ...
            as="a"
            :href="item.href"
            :class="[item.current ? 'bg-gray-100' : 'hover:bg-gray-100', 'block px-3 py-2 rounded-md font-medium text-gray-900']"
            :aria-current="item.current ? 'page' : undefined"
          >
            {{ item.name }}
          </DisclosureButton>
